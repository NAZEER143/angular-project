...
import { EventDialogComponent } from 'src/app/components/calendar/event-dialog/event-dialog.component';
...
export class SidebarComponent {
  ...
  ngOnChanges(){
    setTimeout(() => {
      $('.is-active').css('color',this.changeColourBg);
      $('.is-active').find('.bx').css('color',this.changeColourBg);
    }, 300);
  }
